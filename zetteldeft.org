...
**** =zetteldeft-file-rename-full= renames visited file

This function allows for direct modification of a filename, without changing the file's title.
