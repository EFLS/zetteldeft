...
#+EXPORT_FILE_NAME: ./docs/zetteldeft
...
Latest additions:
 - *15 Apr*: Replace =avy-goto-char= with =avy-jump=. =avy= functions now work even when =zetteldeft-link-inidicator= is nil.
...
Links are found by concatenating =zetteldeft-link-indicator= and =zetteldeftd-id-regex=.
...
An overview of changes, in addition to those mentioned at the top of this document:
 ...
 - *30 Dec 2020*: Minor fixes for MELPA.
