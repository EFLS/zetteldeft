...
Installing and enabling =zetteldeft= with the default configuration is straightforward with =spacemacs=:
 ...
 - Add the =deft= layer to your =.spacemacs= file and enable =zetteldeft= support:
#+BEGIN_SRC emacs-lisp :tangle no
(setq-default dotspacemacs-configuration-layers
  '((deft :variables deft-zetteldeft t)))
#+END_SRC
- Configure =deft= according to Section [[sec:deft-setup]]
...
Or, if you use MELPA & =use-package=, installing is easy with
