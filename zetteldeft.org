...
Including missing links is especially handy when you want to check wheter all notes with a certain tag are mentioned in a note, or simply to list notes with a specific tag that are not linked to yet.
