...
**** =zetteldeft-search-notes-tagged-with= finds notes with the chosen tag

This function allows quickly searching for a specific tag.
...
(defun zetteldeft-search-notes-tagged-with (&optional str)
  (interactive)
  (let* ((tags (seq-sort 'string-lessp (seq-filter 'stringp (zetteldeft--get-all-tags))))
         (search-term (if str
                          str
                        (completing-read "Tag to search for: " tags))))
