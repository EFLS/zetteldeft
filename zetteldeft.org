...
Latest additions:
 - *11 Mar*: Add =zetteldeft-insert-tag=.
...
**** =zetteldeft-tag-prefix= for insert tag
...
Select tag from the minibuffer and insert. Append =zetteldeft-tag-prefix=
for new tags.

Based on =zetteldeft--get-all-tags=.
