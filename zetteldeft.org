...
**** =zd-id-insert= inserts a newly generated ID

A helper function to insert a newly generated id.
...
**** =zd-id-sanitized= filters the ID from a string
...
(zd-id-sanitized "2018-11-09-1934-12 Some text (1989) - testing (2000 p. 12-25)")
#+END_SRC
